...
const list = [
  {
    number: 1,
    title: "Let's complete this",
    date: new Date("9/27/2022").toLocaleDateString("en-US"),
  },
  {
    number: 2,
    title: "Should sleep at 9pm",
    date: new Date("9/28/2022").toLocaleDateString("en-US"),
  },
  {
    number: 3,
    title: "Should complete react",
    date: new Date("10/5/2022").toLocaleDateString("en-US"),
  },
];
